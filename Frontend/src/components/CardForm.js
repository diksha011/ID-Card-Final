            ...
            <div className="cardform-outer-box">
                <div className="cardform-box">
                    <form method="POST" className="cardContent">
                        ...
                        <div className="two-group">
                            <div className="code">
                                <p className="cardform-label">Code Type:</p>
                                <input
                                    value="qr code"
                                    name="code"
                                    type="radio"
                                ...
                                />
                                 <span className="codeinp"> QR Code</span>
                                <input
                                    value="bar code"
                                    name="code"
                                    type="radio"
                                    // onChange={handleInput}
                                />
                                  <span className="codeinp">Bar Code</span>
                                <input
                                    value="Both"
                                    name="code"
                                    type="radio"
                                    // onChange={handleInput}
                                />
                                <span className="codeinp">Both</span>
                            </div>
                        ...
                        <div className="two-group">
                            {/* <div className="doj">
                                <p className="cardform-label">Date of Joining</p>
                                <input className="cardFld" id="doj" name="joinDate" type="date" value={user.joinDate} placeholder="dd-mm-yyyy" onChange={handleInput} />
                            </div> */}
